...
export function DashboardShell({ bootstrap, section }: { bootstrap: DashboardBootstrap; section: SectionKey }) {
  ...
  const liveOnly = ["client-journey","leads-sales","visits","offers-pipeline","sales-projects","cohorts","sales-team"].includes(section);
