...
export function LeadsSalesPage({ data }: { data: CompanyDataset }) {
  ...
  const sourceProjectValue=sourceKnownClients.reduce((sum,client)=>sum+client.projectValueTotal,0);
