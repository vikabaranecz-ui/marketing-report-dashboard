  ...
  return <div className="overview-v2 space-y-6">
    ...
    <section>
      ...
      <Card className="p-5">
        ...
        </tbody></table>{sortedSources.some(row=>row.deliveredLeads!==null)&&<p className="chart-footnote mt-3">Supplier-reported lead counts are shown when a verified source file exists. The CRM-attributed count stays visible and company-wide unique-lead totals continue to use CRM identities so overlapping suppliers are not double-counted.</p>}</div>}
      </Card>
      <Card className="mt-4 p-5">
